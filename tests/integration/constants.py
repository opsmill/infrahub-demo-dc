...
BRANCH_TIMEOUT = 300
"""Creating a branch is metadata-only, but it still round-trips through the task manager."""
...
PROPAGATION_DELAY = 5
"""Short settle after a write before reading it back through a different client."""
