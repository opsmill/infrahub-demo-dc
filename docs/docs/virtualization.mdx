...
```text
info  fra1-pve-01: 12/256 vCPU allocated (5% of the limit, 64 physical at 400%)
info  FRA1-PROXMOX-CLUSTER: 16/512 vCPU allocated across 2 hosts (3%), 6% of the 256 available with the largest host lost
